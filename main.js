...
function actualizarColor() {
    ...
    // Actualizar los valores en los formatos de color
    actualizarValoresColor(colorSeleccionado);
}

// Función para actualizar los valores en los formatos de color
function actualizarValoresColor(color) {
    document.getElementById("hexColor").value = color;
    
    var colorEnRGB = hexToRgb(color);
...
document.getElementById("colorPicker").addEventListener("input", actualizarColor);
